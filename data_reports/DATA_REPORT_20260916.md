...
| 項目 | 數值 | 單位 | 資料來源 |
|---|---|---|---|
| 借券餘額 | 2,415,145 | 張 | TWSE TWT96U + TPEX margin_sbl |
| 借券賣出餘額 | unavailable | 張 | TWSE TWT96U + TPEX margin_sbl |
| 借券賣出增減 | unavailable | 張 | TWSE TWT96U + TPEX margin_sbl |
...
|---|---|---|---|---|---|
| S&P 500 | ^GSPC | 7,633.73 | 81.92 | +1.08 | Yahoo Finance Chart API |
| Nasdaq Composite | ^IXIC | 26,398.24 | 419.81 | +1.62 | Yahoo Finance Chart API |
| Nasdaq 100 | ^NDX | 29,431.53 | 486.46 | +1.68 | Yahoo Finance Chart API |
| Dow Jones | ^DJI | 51,769.09 | 307.19 | +0.60 | Yahoo Finance Chart API |
| 費城半導體 SOX | ^SOX | 11,570.44 | 324.33 | +2.88 | Yahoo Finance Chart API |
| VIX | ^VIX | 15.73 | -1.98 | -11.18 | Yahoo Finance Chart API |
...
| 上海綜合 | 000001.SS | 3,875.60 | -16.00 | -0.41 | Yahoo Finance Chart API |
| 深圳成分 | 399001.SZ | 13,409.91 | -44.83 | -0.33 | Yahoo Finance Chart API |
...
|---|---|---|---|---|---|
| S&P500期貨 | ES=F | 7,702.00 | 145.50 | +1.93 | Yahoo Finance Chart API |
| Nasdaq100期貨 | NQ=F | 29,726.00 | 762.50 | +2.63 | Yahoo Finance Chart API |
| 道瓊期貨 | YM=F | 52,224.00 | 717.00 | +1.39 | Yahoo Finance Chart API |
| Russell2000期貨 | RTY=F | 2,915.00 | 53.30 | +1.86 | Yahoo Finance Chart API |
...
| 項目 | Yahoo Finance 代號 | 最新值 | 漲跌點 | 漲跌幅 | 資料來源 |
|---|---|---|---|---|---|
| USD/TWD | TWD=X | 31.87 | 0.09 | +0.29 | Yahoo Finance Chart API |
| DXY美元指數 | DX-Y.NYB | 100.22 | -0.09 | -0.09 | Yahoo Finance Chart API |
| USD/JPY | JPY=X | 155.88 | 0.61 | +0.40 | Yahoo Finance Chart API |
| USD/KRW | KRW=X | 1,381.48 | 17.91 | +1.31 | Yahoo Finance Chart API |
...
| 項目 | Yahoo Finance 代號 | 收盤／最新值 | 漲跌點 | 漲跌幅 | 資料來源 |
|---|---|---|---|---|---|
| 台積電ADR | TSM | 425.41 | 7.69 | +1.84 | Yahoo Finance Chart API |
| 聯電ADR | UMC | 24.28 | 1.75 | +7.79 | Yahoo Finance Chart API |
...
| 項目 | Yahoo Finance 代號 | 收盤／最新值 | 漲跌點 | 漲跌幅 | 資料來源 |
|---|---|---|---|---|---|
| WTI原油期貨 | CL=F | 101.16 | -1.27 | -1.24 | Yahoo Finance Chart API |
| 黃金期貨 | GC=F | 4,404.50 | 17.00 | +0.39 | Yahoo Finance Chart API |
| Bitcoin | BTC-USD | 76,601.75 | 451.43 | +0.59 | Yahoo Finance Chart API |
...
- 事件6：臺南打造全臺唯一「半導體＋AI＋智慧機器人」金三角聚落
  - 來源：Yahoo 台股；發布時間：2026-09-17T15:29:25Z；台北時間：2026-09-17 23:29
  - 摘要：【互傳媒／記者 劉淑宜／台南市 報導】「2026 T-AI-NAN 智匯臺南・永續賦能」臺南市科技產業研討暨策
  - 原文連結：https://tw.stock.yahoo.com/news/%E8%87%BA%E5%8D%97%E6%89%93%E9%80%A0%E5%85%A8%E8%87%BA%E5%94%AF-%E5%8D%8A%E5%B0%8E%E9%AB%94-ai-%E6%99%BA%E6%85%A7%E6%A9%9F%E5%99%A8%E4%BA%BA-%E9%87%91%E4%B8%89%E8%A7%92%E8%81%9A%E8%90%BD-152925326.html
...
| 項目 | 數值 | 資料來源 |
|---|---|---|
| 交易日期 | 2026-09-16 | TAIFEX Proxy |
| 到期月份／到期日 | 202609 | TAIFEX Proxy |
| 資料更新時間 | 2026-09-17 23:51:14 | 本機 |
...
| 項目 | 數值 | 資料來源 |
|---|---|---|
| Call 總成交量 | 317,643 | TAIFEX Proxy |
| Call 總未平倉量 OI | 93,035 | TAIFEX Proxy |
...
| 項目 | 數值 | 資料來源 |
|---|---|---|
| Put 總成交量 | 345,492 | TAIFEX Proxy |
| Put 總未平倉量 OI | 87,447 | TAIFEX Proxy |
...
| 項目 | 數值 | 資料來源 |
|---|---|---|
| Call／Put 成交量比例 | 0.92 | TAIFEX Proxy |
| Call／Put 未平倉量比例 | 1.06 | TAIFEX Proxy |
| Put／Call Ratio | 0.94 | TAIFEX Proxy |
...
| 項目 | 履約價 | OI | 資料來源 |
|---|---|---|---|
| Call OI 第1大履約價 | 46,000 | 5,413 | TAIFEX Proxy |
| Call OI 第2大履約價 | 45,900 | 3,807 | TAIFEX Proxy |
| Call OI 第3大履約價 | 45,800 | 3,362 | TAIFEX Proxy |
| Call OI 最大履約價 | 46,000 | 5,413 | TAIFEX Proxy |

#### Call OI 分布明細 Top10 (機器可讀，到期月份 202609)

| # | 履約價 | OI | 佔比 | 資料來源 |
|---|---|---|---|---|
| C1 | 46,000 | 5,413 | 5.82% | TAIFEX Proxy |
| C2 | 45,900 | 3,807 | 4.09% | TAIFEX Proxy |
| C3 | 45,800 | 3,362 | 3.61% | TAIFEX Proxy |
| C4 | 50,000 | 3,314 | 3.56% | TAIFEX Proxy |
| C5 | 45,850 | 2,948 | 3.17% | TAIFEX Proxy |
| C6 | 48,000 | 2,707 | 2.91% | TAIFEX Proxy |
| C7 | 47,000 | 2,658 | 2.86% | TAIFEX Proxy |
| C8 | 51,000 | 2,642 | 2.84% | TAIFEX Proxy |
| C9 | 46,050 | 2,608 | 2.8% | TAIFEX Proxy |
| C10 | 45,700 | 2,528 | 2.72% | TAIFEX Proxy |
...
| 項目 | 履約價 | OI | 資料來源 |
|---|---|---|---|
| Put OI 第1大履約價 | 45,500 | 4,945 | TAIFEX Proxy |
| Put OI 第2大履約價 | 45,000 | 4,399 | TAIFEX Proxy |
| Put OI 第3大履約價 | 45,700 | 3,860 | TAIFEX Proxy |
| Put OI 最大履約價 | 45,500 | 4,945 | TAIFEX Proxy |

#### Put OI 分布明細 Top10 (機器可讀，到期月份 202609)

| # | 履約價 | OI | 佔比 | 資料來源 |
|---|---|---|---|---|
| P1 | 45,500 | 4,945 | 5.65% | TAIFEX Proxy |
| P2 | 45,000 | 4,399 | 5.03% | TAIFEX Proxy |
| P3 | 45,700 | 3,860 | 4.41% | TAIFEX Proxy |
| P4 | 45,600 | 3,267 | 3.74% | TAIFEX Proxy |
| P5 | 45,750 | 3,206 | 3.67% | TAIFEX Proxy |
| P6 | 45,400 | 3,076 | 3.52% | TAIFEX Proxy |
| P7 | 44,000 | 2,872 | 3.28% | TAIFEX Proxy |
| P8 | 45,300 | 2,839 | 3.25% | TAIFEX Proxy |
| P9 | 46,000 | 2,697 | 3.08% | TAIFEX Proxy |
| P10 | 43,000 | 2,351 | 2.69% | TAIFEX Proxy |
...
| 項目 | 數值 | 資料來源 |
|---|---|---|
| Call Wall 價位 | 46,000 | TAIFEX Proxy |
| 對應到期月份 | 202609 | TAIFEX Proxy |
...
| 項目 | 數值 | 資料來源 |
|---|---|---|
| Put Wall 價位 | 45,500 | TAIFEX Proxy |
| 對應到期月份 | 202609 | TAIFEX Proxy |
| 與前一交易日的變化 | unavailable | 端點未提供 |
...
| 項目 | 數值 | 資料來源 |
|---|---|---|
| Max Pain 價位 | 45,750 | TAIFEX Proxy |
| 對應到期月份 | 202609 | TAIFEX Proxy |
| 與前一交易日的變化 | unavailable | 端點未提供 |
...
- 資料日期：2026-09-16；資料時間：2026-09-17 23:51:14；時區：`Asia/Taipei`
- 日盤／夜盤標記：日盤收盤後 + 夜盤盤後
- 未取得欄位 (13)：otc_breadth.up, otc_breadth.down, otc_breadth.flat, otc_breadth.limit_up, otc_breadth.limit_down, margin.ratio, sbl.sale_bal, sbl.sale_chg, turnover.otc, futures.top10_change, options.chain_oi_change, options.pos_change, options.wall_change
